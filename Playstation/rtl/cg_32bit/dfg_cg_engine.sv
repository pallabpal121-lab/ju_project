// =============================================================================
// File Name   : dfg_cg_engine.sv
// Module Name : dfg_cg_engine
// Project     : Non-Linear Conjugate Gradient (CG) Accelerator (Solver #5)
// -----------------------------------------------------------------------------
// Description for Freshers & Beginners:
//   Programmable DFG Model Evaluator for Conjugate Gradient optimization.
//   Evaluates f(x0, x1, ...) given parameter vector x (loaded into r0..r(N-1)).
// =============================================================================
