// =============================================================================
// File Name   : dfg_adam_engine.sv
// Module Name : dfg_adam_engine
// Project     : Adaptive Moment Estimation (Adam) Accelerator (Solver #17)
// -----------------------------------------------------------------------------
// Description:
//   Programmable DFG Model & Objective Evaluator for Neural Loss Optimization.
//   Evaluates arbitrary loss function f(θ) given coordinate vector θ (loaded
//   into r0..r3). Returns scalar loss in r15.
// =============================================================================
