// =============================================================================
// File Name   : dfg_pso_engine.sv
// Module Name : dfg_pso_engine
// Project     : Particle Swarm Optimization (PSO) Accelerator (Solver #14)
// -----------------------------------------------------------------------------
// Description:
//   Programmable DFG Model & Fitness Landscape Evaluator for PSO Optimization.
//   Evaluates arbitrary non-convex fitness function f(x) given particle position
//   vector x (loaded into r0..r3). Returns scalar fitness in r15.
// =============================================================================
            ...
            case (state)
                ENG_IDLE: begin
                    ...
                    if (start_eval) begin
                        busy <= 1'b1;
                        pc   <= '0;
                        for (int i = 0; i < MAX_DIMS; i++) begin
                            if (i < num_dims) begin
