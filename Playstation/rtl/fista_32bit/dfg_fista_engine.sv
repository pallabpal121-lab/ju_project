// =============================================================================
// File Name   : dfg_fista_engine.sv
// Module Name : dfg_fista_engine
// Project     : Fast Iterative Shrinkage-Thresholding Algorithm (FISTA) Accelerator (Solver #15)
// -----------------------------------------------------------------------------
// Description:
//   Programmable DFG Model & Objective Evaluator for FISTA Optimization.
//   Evaluates differentiable objective f(x) given coordinate vector x (loaded
//   into r0..r3). Returns scalar cost in r15.
// =============================================================================
