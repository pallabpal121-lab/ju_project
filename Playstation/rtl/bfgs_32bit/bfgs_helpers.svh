// =============================================================================
// File Name   : bfgs_helpers.svh
// Description : Fast synthesizable inline functions for BFGS vector and matrix access
// =============================================================================

`ifndef BFGS_HELPERS_SVH
`define BFGS_HELPERS_SVH
