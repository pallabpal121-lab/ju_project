// =============================================================================
// File Name   : dfg_ipm_engine.sv
// Module Name : dfg_ipm_engine
// Project     : Primal-Dual Interior Point Method (IPM) Accelerator (Solver #16)
// -----------------------------------------------------------------------------
// Description:
//   Programmable DFG Model & Objective Evaluator for IPM Optimization.
//   Evaluates arbitrary objective f(x) given coordinate vector x (loaded
