// =============================================================================
// File Name   : de_helpers.svh
// Project     : Differential Evolution (DE) Accelerator (Solver #30)
// -----------------------------------------------------------------------------
// Description:
//   Population indexing, individual accessors, bounds clamping, and inlined
//   objective fitness evaluators (Quadratic, Rosenbrock, Sphere, Rastrigin).
// =============================================================================

`ifndef DE_HELPERS_SVH
`define DE_HELPERS_SVH
