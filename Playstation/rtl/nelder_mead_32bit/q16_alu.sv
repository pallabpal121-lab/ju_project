...
// Module Name : q16_alu
// Project     : Nelder-Mead Simplex Direct Search Accelerator
// -----------------------------------------------------------------------------
// Description: Combinational Q16.16 Fixed-Point Arithmetic Logic Unit with OP_ABS.
// =============================================================================
...
module q16_alu (
    ...
    always_comb begin
        ...
        case (op)
            ...
            OP_ABS: begin
                result = (src_a < 32'sd0) ? -src_a : src_a;
            end
