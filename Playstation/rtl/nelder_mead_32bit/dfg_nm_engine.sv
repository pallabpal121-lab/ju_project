// =============================================================================
// File Name   : dfg_nm_engine.sv
// Module Name : dfg_nm_engine
// Project     : Nelder-Mead Simplex Direct Search Accelerator (Solver #8)
// -----------------------------------------------------------------------------
// Description for Freshers & Beginners:
//   Programmable DFG Model Evaluator for Nelder-Mead optimization.
//   Evaluates arbitrary non-linear & non-smooth objective functions f(x).
// =============================================================================
