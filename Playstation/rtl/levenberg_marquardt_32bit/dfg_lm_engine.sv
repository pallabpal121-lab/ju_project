// =============================================================================
// File Name   : dfg_lm_engine.sv
// Module Name : dfg_lm_engine
// Project     : Levenberg-Marquardt (LM) Non-Linear Least Squares Accelerator
// -----------------------------------------------------------------------------
// Description for Freshers & Beginners:
//   Programmable DFG Model Evaluator for Levenberg-Marquardt optimization.
//   Evaluates f(t_m, x0, x1, ...) given an independent observation value t_m (r14)
//   and parameter vector x (r0..r(N-1)).
// =============================================================================
...
module dfg_lm_engine (
    ...
    input  vec_t               x_vec,
    input  q16_t               t_in,        // Independent variable input t_m (loaded into r14)
    output q16_t               f_out,       // Output model prediction f(t_m, x)
            ...
            case (state)
                ENG_IDLE: begin
                    ...
                    if (start_eval) begin
                        ...
                        reg_file[REG_T_IN] <= t_in; // r14 = t_m
