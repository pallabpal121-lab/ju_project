...
The suite includes five specialized hardware architectures:
...
│   │   └── irls_32bit/                  # [NEW] Solver #3: IRLS Suite
...
│       ├── Makefile                     # Build & run Makefile (all 5 targets)
